...
const speakers = {
  IcaroHeimig: createSpeaker("Ícaro Heimig", {
    bio: {
  ...
  GutoFoletto: createSpeaker("Guto Foletto", {
    bio: {
  ...
  MatheusAzzi: createSpeaker("Matheus Azzi", {
    bio: {
  ...
  AlmirFilho: createSpeaker("Almir Filho", {
    bio: {
  ...
  GuilhermeSerrano: createSpeaker("Guilherme Serrano", {
    bio: {
...
export default class SpeakersData {
  ...
  static getBioData() {
    let data = {};
    let oSpeakers = this.getData();
    for (let key in oSpeakers) {
      data[key] = oSpeakers[key].bio;
    }
    return data;
  }
  ...
  static getTalkData() {
    ...
    let oSpeakers = this.getData();
    for (let key in oSpeakers) {
      data[key] = oSpeakers[key].talk;
    }
    return data;
  }

  static getBioDataArray() {
    let data = [];
    let oSpeakers = this.getData();
    for (let key in oSpeakers) {
      data.push(oSpeakers[key].bio);
    }
    return data;
  }

  static getTalkDataArray() {
    let data = [];
    let oSpeakers = this.getData();
    for (let key in oSpeakers) {
      data.push(oSpeakers[key].talk);
    }
    return data;
  }
}
